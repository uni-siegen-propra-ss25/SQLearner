...
import { ApiTags, ApiOperation, ApiResponse, ApiUnauthorizedResponse, ApiBearerAuth, ApiBody } from '@nestjs/swagger';
...
export class AuthController {
  ...
  @ApiResponse({ status: 200, description: 'JWT access token and user data', type: LoginResponseDto })
